...
[![Windows Version](https://img.shields.io/badge/Windows-10%2F11-0078D6?style=for-the-badge&logo=windows11&logoColor=white)](https://github.com/Kishanx08/movx/releases)
...
[![Architecture](https://img.shields.io/badge/Arch-x64-blue?style=for-the-badge)](https://github.com/Kishanx08/movx/releases/latest)
...
```mermaid
flowchart LR
    A[1. Download Setup] --> B[2. Run Installer]
    B --> C[3. SmartScreen: Run Anyway]
    C --> D[4. Launch MovX!]
```
...
<details>
<summary><b>🛡️ Why does Windows SmartScreen show a prompt during setup?</b></summary>
<br/>
...
<details>
<summary><b>🖥️ Can I run MovX on 32-bit Windows?</b></summary>
<br/>
MovX is compiled specifically for 64-bit Windows 10 and 11 to ensure maximum performance and modern codec support.
</details>

<details>
<summary><b>🐛 How do I submit feedback or report bugs?</b></summary>
<br/>
